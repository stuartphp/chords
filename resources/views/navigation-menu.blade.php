        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @endcan
                    @can('medical_access')
                    <x-jet-nav-link href="#" :active="request()->is('medical/*')" :dropdown="true" title="{{ __('Medical Access') }}">
                            <x-icon-person-plus class="h-6 w-6"/>
                        <x-slot name="children">
                            @can('doctors_access')
                            <a href="{{ route('medical.doctor') }}">Doctors</a>
                            @endcan
